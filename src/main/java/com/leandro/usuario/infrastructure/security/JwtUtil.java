package com.leandro.usuario.infrastructure.security;
...
public class JwtUtil {
    ...
    public String generateToken(String username) {
        return Jwts.builder() // Inicia o processo de construção do token JWT
                ...
                .expiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60)) // Define a data e hora de expiração do token para 1 hora(milisegundos))a partir da emissão
                .signWith(getSigningKey()) // Assina o token usando a chave de assinatura fornecida pelo metodo getSigningKey()
